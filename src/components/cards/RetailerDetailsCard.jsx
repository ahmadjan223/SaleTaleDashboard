...
const RetailerDetailsCard = ({ retailer, onClose }) => {
      ...
      >
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ flex: '1 1 45%' }}>
            ...
            <p style={{ margin: '4px 0 0', fontSize: '16px', color: 'var(--text-light)', fontWeight: 'bold' }}>
              {retailer.retailerName || 'N/A'}
            </p>
          </div>
          <div style={{ flex: '1 1 45%' }}>
            <p style={{ margin: 0, fontSize: '14px', color: 'var(--text-light)', opacity: 0.7 }}>Shop Name</p>
            <p style={{ margin: '4px 0 0', fontSize: '16px', color: 'var(--text-light)', fontWeight: 'bold' }}>
          ...
          {retailer.assignedSalesman && (
            <>
              <div style={{ flex: '1 1 45%' }}>
                <p style={{ margin: 0, fontSize: '14px', color: 'var(--text-light)', opacity: 0.7 }}>Assigned Salesman</p>
                <p style={{ margin: '4px 0 0', fontSize: '16px', color: 'var(--text-light)', fontWeight: 'bold' }}>
                  {retailer.assignedSalesman.name || 'N/A'}
                </p>
              </div>
              <div style={{ flex: '1 1 45%' }}>
                <p style={{ margin: 0, fontSize: '14px', color: 'var(--text-light)', opacity: 0.7 }}>Salesman Contact</p>
                <p style={{ margin: '4px 0 0', fontSize: '16px', color: 'var(--text-light)', fontWeight: 'bold' }}>
                  {retailer.assignedSalesman.contactNo || 'N/A'}
                </p>
              </div>
          ...
          <div style={{ flex: '1 1 45%' }}>
            ...
            <p style={{ margin: '4px 0 0', fontSize: '16px', color: retailer.active ? 'var(--accent-green)' : 'var(--danger-red)', fontWeight: 'bold' }}>
