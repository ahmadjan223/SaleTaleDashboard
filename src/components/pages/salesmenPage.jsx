...
const SalesmenPage = () => {
  ...
  useEffect(() => {
    if (salesmen) {
      let filtered = salesmen.filter(salesman => searchSalesman(salesman, searchQuery));
      if (sortBy === 'name_az') {
      ...
      <div className="section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div>
            ...
            >
              <option value="name_az">Salesman Name: A-Z</option>
              <option value="name_za">Salesman Name: Z-A</option>
            </select>
          </div>
          <div className="header-actions">
